...
public class Titles {
    ...
    public static void sendTitle(Player p, Integer fadeIn, Integer stay, Integer fadeOut, String title, String subtitle) {
        ...
        if (BetterDeathScreen.veryNewVersion()) {
            ...
            try {
                ProtocolLibrary.getProtocolManager().sendServerPacket(p, time_packet);
                ProtocolLibrary.getProtocolManager().sendServerPacket(p, subtitle_packet);
                ProtocolLibrary.getProtocolManager().sendServerPacket(p, title_packet);
